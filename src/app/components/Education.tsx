...
const Education = () => {
	return (
		<div
			className='bg-[#0a0a0a] px-10 sm:px-20 md:px-40 mx-auto flex flex-col items-center py-12'
			id='education'
		>
			...
			<div className='mt-6 flex flex-wrap justify-center w-full md:w-3/4 gap-3'>
				{educations.map((education, index) => (
					<div
						className='flex flex-col gap-6 w-full md:w-5/12 bg-[#0c0c0c] shadow-black shadow-lg rounded-sm p-4'
						key={index}
					>
